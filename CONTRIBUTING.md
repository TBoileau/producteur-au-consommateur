...
## Issues
[Issues](https://github.com/TBoileau/mediplace/issues) est le canal idéal pour les rapports de bug, les nouvelles fonctionnalités ou pour soumètre une `pull requests`, cependant veuillez a bien respecter les restrictions suivantes :
...
Guide :
1. Assurez-vous de ne pas créer un rapport déjà existant, pensez à utiliser [le système de recherche](https://github.com/TBoileau/mediplace/issues).
...
1. [Fork](http://help.github.com/fork-a-repo/) le projet, clonez votre `fork` et configurez les `remotes`:
    ...
    cd mediplace
    git remote add upstream https://github.com/TBoileau/mediplace
    ```
